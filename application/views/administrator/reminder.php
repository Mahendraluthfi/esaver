                                            ...
                                            <?php $no=1; foreach ($below as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php 
                                                     ...
                                                     ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url('administrator/reminder/ver/'.$data->user_id) ?>" class="btn btn-primary" onclick="return confirm('Anda yakin verifikasi data ini ?')"><i class="ik ik-check"></i> Verifikasi</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
