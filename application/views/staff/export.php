...
<div class="row clearfix">
    ...
    <div class="col-sm-4 col-md-4 col-lg-4">
        <a href="<?php echo base_url('staff/export/exportexcel') ?>" class="btn btn-primary" style="width: 100%; font-size: 20px; height: auto;"><i class="ik ik-download"></i> Export Data</a>
    </div>
    <div class="col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">                    
                    <?php echo form_open_multipart('staff/export/upload', array('class' => 'forms-sample')); ?>
